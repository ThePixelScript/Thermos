...
import { Zone, RiskLevel, getRiskFromTemp } from '../types';
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-100">
              {filteredZones.map((zone) => {
                // Find actual global index in sortedZones
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3.5 px-4">
                      <div className="flex items-center space-x-2">
                        <div>
                          ...
                          <div className="text-[10px] text-slate-400">{zone.district} • {zone.landUse}</div>
                        </div>
                      </div>
                    </td>
                    ...
                    {/* Risk Tier Badge */}
                    <td className="py-3.5 px-4">
                      <span className={`px-2.5 py-1 rounded text-[10px] font-extrabold uppercase border ${getRiskBadgeStyles(derivedRisk)}`}>
                        {derivedRisk}
                      </span>
                    </td>
                    ...
                    <td className="py-3.5 px-4 font-mono-data">
                      ...
                      <div className="text-[10px] text-slate-400">
                        HVI: <span className={zone.hvi >= 7 ? 'text-red-600 font-bold' : 'text-slate-600 font-medium'}>{zone.hvi} / 10</span>
                      </div>
                    </td>
